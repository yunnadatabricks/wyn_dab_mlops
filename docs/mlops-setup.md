...
git add README.md docs .gitignore wyn_dab_mlops/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[wyn_dab_mlops/databricks.yml](../wyn_dab_mlops/databricks.yml) file.
...
Follow the instructions in [wyn_dab_mlops/resources/README.md](../wyn_dab_mlops/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../wyn_dab_mlops/resources/README.md)  to propose, test, and deploy
